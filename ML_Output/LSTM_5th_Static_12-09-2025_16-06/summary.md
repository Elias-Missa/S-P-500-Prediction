...
- RMSE: 0.010612
- MAE: 0.009196
- Directional Accuracy: 99.18%

### Test (Out of Sample)
- RMSE: 0.007178
- MAE: 0.006358
- Directional Accuracy: 95.37%
- IC: 0.9952
- Strategy Return: 23.7842
- Sharpe Ratio: 4.95
- Max Drawdown: -0.0151

#### Big Shift Details
- Precision (Up): 0.71 (Count: 133)
- Recall (Up): 1.00 (Count: 94)
- Precision (Down): 1.00 (Count: 22)
- Recall (Down): 0.63 (Count: 35)

## Features Used
Total Features: 18
List: MA_Dist_200, Hurst, Return_1M, Return_3M, Return_6M, Return_12M, Slope_50, Slope_100, RV_Ratio, GARCH_Forecast, Vol_ROC, Sectors_Above_50MA, HY_Spread, USD_Trend, Oil_Deviation, Yield_Curve, Imp_Real_Gap, Log_Target_1M

...
- Annualized Volatility: 0.0410
- Sharpe Ratio: 0.58
- Max Drawdown: -0.0327
- Trade Count: 4
- Holding Frequency: 11.8%
- Avg Return per Trade: 0.0167

#### Big Move Detection Performance
- Precision (Up): 0.55 (Predicted: 182)
- Recall (Up): 0.34 (Actual: 290)
...
- P-value: 0.0000
- Monotonicity: +0.539
- Top Decile Mean: +0.0426
- Bottom Decile Mean: +0.0203

**Coverage vs Performance:**
- Best Threshold: 0.0075
- Coverage at Best: 76.5%
- Sharpe at Best: 1.47
- Coverage-Sharpe Corr: +0.897
...
- **Criterion**: sharpe
- **Threshold Mean**: 0.0152
- **Threshold Std**: 0.0134
- **Threshold Range**: [0.0020, 0.0568]
- **Val Sharpe (avg)**: 2.83
- **Test Sharpe (avg)**: 0.00 ± 0.00
- **Test Hit Rate (avg)**: 0.0%
- **Test IC (avg)**: 0.000
- **Total Trades**: 23
- **Per-Fold τ**: [0.0074, 0.0124, 0.0250, 0.0148, 0.0293, 0.0284, 0.0050, 0.0229, 0.0098, 0.0050, 0.0100, 0.0190, 0.0473, 0.0568, 0.0024, 0.0050, 0.0050, 0.0077, 0.0123, 0.0025, 0.0020, 0.0047, 0.0163, 0.0065, 0.0090, 0.0036, 0.0188, 0.0100, 0.0324, 0.0400, 0.0026, 0.0269, 0.0100, 0.0050]
...
|--------------|--------|----------|
| % Positive (>0) | 74.2% | 82.2% |
| % Big Up (>3%) | 39.2% | 24.6% |
| % Big Down (<-3%) | 11.2% | 1.5% |

### Fold-Level Analysis
**IC across folds**: mean=0.3613, std=0.3505

**Best 3 folds by IC**:
- Fold 22: IC=0.8519, Dir Acc=76.2%, Test: 2024-11-01 to 2024-11-29
- Fold 9: IC=0.8251, Dir Acc=78.3%, Test: 2023-10-01 to 2023-10-31
- Fold 2: IC=0.7806, Dir Acc=100.0%, Test: 2023-03-01 to 2023-03-31

**Worst 3 folds by IC**:
- Fold 3: IC=-0.1325, Dir Acc=76.2%, Test: 2023-04-01 to 2023-04-28
- Fold 28: IC=-0.2998, Dir Acc=86.4%, Test: 2025-05-01 to 2025-05-30
- Fold 11: IC=-0.7065, Dir Acc=90.5%, Test: 2023-12-01 to 2023-12-29

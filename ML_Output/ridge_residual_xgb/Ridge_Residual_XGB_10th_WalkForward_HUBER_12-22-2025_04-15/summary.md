...
- P-value: 0.0057
- Monotonicity: +0.867
- Top Decile Mean: +0.0504
- Bottom Decile Mean: -0.0198
...
|--------|-----------|----|----------|---------------|-------------|
| **1** | 100.0% (22) | 0.7516 | 68.2% | 0.0701 | 0.0316 |
...
- **Criterion**: sharpe
- **Threshold Mean**: 0.0200
- **Threshold Std**: 0.0000
- **Threshold Range**: [0.0200, 0.0200]
- **Val Sharpe (avg)**: 18.32
...
|--------------|--------|----------|
| % Positive (>0) | 72.7% | 40.9% |
| % Big Up (>3%) | 54.5% | 0.0% |
| % Big Down (<-3%) | 0.0% | 0.0% |

### Fold-Level Analysis
**IC across folds**: mean=0.7516, std=0.0000

**Best 3 folds by IC**:
- Fold 0: IC=0.7516, Dir Acc=68.2%, Test: 2023-01-02 to 2023-01-31

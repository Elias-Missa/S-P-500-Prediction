...
- **Criterion**: sharpe
- **Threshold Mean**: 0.0165
- **Threshold Std**: 0.0103
- **Threshold Range**: [0.0029, 0.0537]
- **Val Sharpe (avg)**: 22.52
- **Test Sharpe (avg)**: 0.00 ± 0.00
- **Test Hit Rate (avg)**: 0.0%
- **Test IC (avg)**: 0.000
- **Total Trades**: 18
- **Per-Fold τ**: [0.0200, 0.0134, 0.0175, 0.0143, 0.0075, 0.0150, 0.0348, 0.0179, 0.0185, 0.0200, 0.0033, 0.0537, 0.0035, 0.0050, 0.0432, 0.0150, 0.0250, 0.0150, 0.0188, 0.0100, 0.0179, 0.0169, 0.0174, 0.0165, 0.0170, 0.0159, 0.0181, 0.0031, 0.0029, 0.0078, 0.0128, 0.0149, 0.0148, 0.0141]

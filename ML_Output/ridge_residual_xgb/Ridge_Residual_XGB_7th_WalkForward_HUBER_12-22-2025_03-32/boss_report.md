...
## 1. Executive Summary
Analysis of Ridge_Residual_XGB model predicting S&P 500 21-day returns.
...
Model Type: Ridge_Residual_XGB (Regularized Linear Regression)
...
## Stack Decomposition
Ridge-Residual Correlation: -0.5165
Var(Ridge): 0.000059 | Var(Resid): 0.000075
Resid/Ridge Ratio: 1.28x
...
| L/S (Daily Overlap) | -0.22% | -2.46% | 0.74% | -3.35 | -0.72 | -11.33 |
| Long Only (Daily) | 0.61% | 7.20% | 2.06% | 3.49 | inf | 0.00 |
| L/S (Monthly Rebal) | 6.24% | 99.94% | 15.88% | 6.29 | 5.06 | 40.39 |
| Big Move (Daily) | 0.00% | 0.00% | 0.00% | 0.00 | inf | 0.00 |
| Vol Target 15% (Daily) | -0.21% | -2.43% | 0.72% | -3.35 | -0.72 | -11.33 |
...
| L/S (Daily Overlap) | -0.22% | 1 | 0.0% | 0.00 | -0.01 | -0.266 | -0.02 | -0.00 |
| Long Only (Daily) | 0.00% | 0 | 4.5% | 0.00 | 0.04 | 0.266 | 0.05 | -0.00 |
| L/S (Monthly Rebal) | -2.47% | 4 | 54.5% | 2.12 | 1.05 | 1.000 | 1.00 | 1.01 |
| Big Move (Daily) | 0.00% | 0 | 0.0% | 0.00 | 0.00 | 0.000 | 0.00 | -0.00 |
| Vol Target 15% (Daily) | -0.21% | 1 | 0.0% | 0.00 | -0.01 | -0.266 | -0.02 | -0.00 |

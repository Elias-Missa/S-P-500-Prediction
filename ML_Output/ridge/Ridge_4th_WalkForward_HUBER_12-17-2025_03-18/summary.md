...
- **Criterion**: sharpe
- **Threshold Mean**: 0.0097
- **Threshold Std**: 0.0080
- **Threshold Range**: [0.0019, 0.0400]
- **Val Sharpe (avg)**: 8.56
- **Test Sharpe (avg)**: 8.70 ± 17.75
- **Test Hit Rate (avg)**: 65.8%
- **Test IC (avg)**: 0.458
- **Total Trades**: 505
- **Per-Fold τ**: [0.0200, 0.0160, 0.0150, 0.0165, 0.0050, 0.0036, 0.0069, 0.0050, 0.0050, 0.0150, 0.0050, 0.0400, 0.0314, 0.0050, 0.0029, 0.0024, 0.0019, 0.0033, 0.0050, 0.0050, 0.0050, 0.0065, 0.0088, 0.0095, 0.0093, 0.0056, 0.0093, 0.0150, 0.0093, 0.0102, 0.0094, 0.0092, 0.0080, 0.0040]
